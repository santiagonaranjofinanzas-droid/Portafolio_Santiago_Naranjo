...
input int    InpMagic         = 40001;   // Magic Number (V30 Series)
...
input string InpIndiPath      = "Sovereign\\Sovereign_40001_Signal"; // V8.1 Required
...
int OnInit() {
    ...
    Print("Sovereign 40001 EA initialized successfully.");
