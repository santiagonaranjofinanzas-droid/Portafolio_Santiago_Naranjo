...
#property description "H18 TREND_10 with shared institutional risk - DEMO/TESTER ONLY"
...
const long H18_MAGIC=6001;
CH18SlowTrendEngine engine;

int OnInit()
  {
   return engine.Init("TREND_10_MEDIUM_LONG",H18_MAGIC,12,24,48,6.0,
